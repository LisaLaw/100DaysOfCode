class Calculator {
    ...
    getDisplayNumber(number) {
        ...
        if (decimalDigits !== null) {//user entered a period and numbers
    ...
    update() {
        ...
        if(this.operation != null) {//when we have a previous op
            ...
            this.previousOperandTextElement = '' //leaves us only with final result, clears prev operation
        }
        
        //update previous op field
